...
describe('ResourceBreadcrumbs', () => {
  it('should render breadcrumbs', async () => {
    const resource: Resource<{ [key: string]: unknown }> = {
      ...
      properties: {
        application: '/planes/radius/local/resourceGroups/default/providers/applications.core/applications/dashboard-app',
        environment: '/planes/radius/local/resourceGroups/default/providers/applications.core/environments/default',
      },
      systemData: {},
    };
    const rendered = await renderInTestApp(<ResourceBreadcrumbs resource={resource} />, {
      mountedRoutes: {
    ...
    expect(
      screen.getByRole('link', { name: 'dashboard-app' }),
    ).toHaveAttribute(
      'href',

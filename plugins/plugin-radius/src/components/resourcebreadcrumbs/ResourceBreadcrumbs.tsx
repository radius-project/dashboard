...
export const ResourceBreadcrumbs = (props: { resource: Resource }) => {
  const properties = props.resource.properties as ResourceWithEnvApp | undefined;
  return (
    <Breadcrumbs>
      {properties?.environment && (
        <ResourceLink id={properties.environment} />
      )}
      {properties?.application && (
        <ResourceLink id={properties.application} />
      )}

...
export const ResourceTypeDetailPage = () => {
  ...
  if (!resourceType)
    return <ResponseErrorPanel error={new Error('Resource type not found')} />;
                ...
                {Object.entries(resourceType.APIVersions || {})
                  ...
                  .map(([version, versionData]) => {
                    ...
                    if (typedVersionData.schema?.properties) {
                      schemaInfo = {
                        properties: typedVersionData.schema
                          .properties as Record<string, unknown>,
                        required:
                          (typedVersionData.schema.required as string[]) || [],
                      };
                      ...
                      const findProperties = (
                        ...
                        if (typed.properties) {
                          return {
                            properties: typed.properties as Record<
                              string,
                              unknown
                            >,
                            required: typed.required as string[],
                          };
                        }
                        ...
                        if (
                          typed.definitions &&
                          typeof typed.definitions === 'object'
                        ) {
                          const definitions = typed.definitions as Record<
                            string,
                            unknown
                          >;
                    ...
                    const properties = propertiesSchemaInfo?.properties
                      ? Object.entries(propertiesSchemaInfo.properties)
                          ...
                          .map(([propName, propSchema]: [string, unknown]) => {
                            ...
                            const actualRequiredFields =
                              propertiesSchemaInfo?.required || [];
                    ...
                    const extractNestedProperties = (
                      ...
                      if (
                        ...
                        const nestedProps = Object.entries(schema.properties)
                          ...
                          .map(
                            ([nestedPropName, nestedPropSchema]: [
                              ...
                              let nestedPropType =
                                typedNestedProp.type || 'object';
                              if (typedNestedProp.$ref) {
                                const refMatch =
                                  typedNestedProp.$ref.match(/[^/]+$/);
                                if (refMatch) {
                        ...
                        const hasAdditionalProps =
                          ...
                          (schema.properties &&
                            'additionalProperties' in schema.properties);
                        ...
                        if (hasAdditionalProps) {
                          ...
                          nestedProps.push({
                            ...
                            required: false,
                            description: formatDescription(
                              additionalPropsSchema?.description ||
                      ...
                      if (
                        ...
                        const nestedProps = Object.entries(
                          schema.items.properties,
                        )
                      ...
                      if (
                        ...
                        const nameProperty = {
                          ...
                          description: parentDescription
                            ? formatDescription(parentDescription)
                            : '',
                          schema: {
                            type: 'string',
                            description: parentDescription
                        ...
                        const nestedProps = [
                          ...
                          ...Object.entries(
                            ...
                            .filter(
                              ([, nestedPropSchema]: [string, unknown]) => {
                                const typedNestedProp = nestedPropSchema as {
                                  readOnly?: boolean;
                                };
                                return typedNestedProp.readOnly !== true;
                      ...
                      for (const prop of props) {
                        ...
                        if (nested && nested.properties.length > 0) {
                          ...
                          const fullPath = cleanPrefix
                            ? `${cleanPrefix}.${prop.name}`
                            : prop.name;
                          tables.push({
                            id: tableId,
                            title: `${fullPath} Properties`,
                            parentProperty: prop.name,
                            parentDescription: prop.description
                          ...
                          const nestedTables = collectAllNestedTables(
                            nested.properties,
                            `${tableId}.`,
                          );
                        ...
                        {nestedTables.map(table => (
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                {table.parentDescription ||
                                  `Properties for the ${table.parentProperty} object`}
                              </Typography>
                            </Typography>
                                        ...
                                        nestedTables.some(
                                          ...
                                          <a
                                            ...
                                            onClick={e => {
                                              ...
                                              const element =
                                                document.getElementById(
                                                  `${version}-${table.id}.${property.name}`,
                                                );
                                              if (element) {
                                                element.scrollIntoView({
                                                  behavior: 'smooth',
                              ...
                              <a
                                ...
                                onClick={e => {
                                  ...
                                  if (!table.id.includes('.')) {
                                    ...
                                    const parentId = table.id.substring(
                                      0,
                                      table.id.lastIndexOf('.'),
                                    );
                                    // If parentId has no dots, it's a top-level property
                                    const targetId = parentId.includes('.')
                                      ? `${version}-${parentId}`
                                      : `${version}-${parentId}`;
                                    const element =
                                        ...
                                        nestedTables.some(
                                          ...
                                          <a
                                            ...
                                            onClick={e => {
                                              ...
                                              const element =
                                                document.getElementById(
                                                  `output-${version}-${table.id}.${property.name}`,
                                                );
                                              if (element) {
                                                element.scrollIntoView({
                                                  behavior: 'smooth',
